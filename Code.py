...
train_tf = Compose([
    ...
    RandAffined(keys="image", prob=0.15, rotate_range=0.04, shear_range=0.02),
    ...
    RandCoarseDropoutd(keys="image", holes=1, max_holes=3,
...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_ds, batch_size=BATCH, num_workers=NUM_W, shuffle=True, pin_memory=True)
